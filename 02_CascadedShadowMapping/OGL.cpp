...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	Shader simpleDepthShader("shaders/shadow_mapping_depth.vs", "shaders/shadow_mapping_depth.fs", "shaders/shadow_mapping_depth.gs");
	Shader debugDepthQuad("shaders/debug_quad.vs", "shaders/debug_quad_depth.fs");
	Shader debugCascadeShader("shaders/debug_cascade.vs", "shaders/debug_cascade.fs");
